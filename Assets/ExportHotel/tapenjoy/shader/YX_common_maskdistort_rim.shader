Shader "YX/common/maskdistort_rim" {
	Properties {
		_Wai_Color ("Wai_Color", Vector) = (0.5,0.5,0.5,1)
		_Waiquan_Width ("Waiquan_Width", Range(0, 10)) = 1
		_Nei_Color ("Nei_Color", Vector) = (0.5,0.5,0.5,1)
		_Neiquan_Width ("Neiquan_Width", Range(0, 10)) = 1
		[MaterialToggle] _MaskTex_CustomUV ("MaskTex_CustomUV", Float) = 0
		[MaterialToggle] _MaskTex_switch ("MaskTex_switch", Float) = 0
